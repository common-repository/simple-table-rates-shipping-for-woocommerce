...
use WPRuby_Str\Core\App\Endpoints\Endpoints_Factory;
use WPRuby_Str\Core\App\Frontend\App_Page;
use WPRuby_Str\Core\License\Handler;
use WPRuby_Str\Core\License\Updater;
...
class Core {
	...
	{
		$methods['simple_table_rates'] = Simple_Table_Rates_Shipping_Method::class;
		return $methods;
	}
	...
	{
		require_once plugin_dir_path( __FILE__ ) . 'class-simple-table-rates-shipping-method.php';
	}
